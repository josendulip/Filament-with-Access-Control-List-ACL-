...
return [
    ...
    */
    ...
    'widgets' => [
        ...
        'register' => [
            ...
            //Widgets\FilamentInfoWidget::class, //remover o widgets que aparece la na pagina ao aparecer "filament"
        ],
    ],
    ...
    */
    ...
    'layout' => [
        ...
        'footer' => [
            'should_show_logo' => false, //aparece uma logo da filamente que nao precisamos "true" 
        ],
        ...
        'sidebar' => [
            'is_collapsible_on_desktop' => true, //colocando um colapse no menu side bar "false"
            'groups' => [
